            ...
            >
              ...
              <div>
                <p>
                  ...
                  <input id='name' type='text' style={{ borderRadius: '4px', border: '1px solid #bbb', padding: '7px' }} />
                </p>
              </div>
              ...
              <div>
                <p>
                  ...
                  <textarea id='contribution' style={{ minWidth: '245px', minHeight: '100px', borderRadius: '4px', border: '1px solid #bbb' }} />
                </p>
              </div>
              ...
              <div>
                <p>
                  ...
                  <input id='email' type='email' style={{ borderRadius: '4px', border: '1px solid #bbb', padding: '7px' }} />
                </p>
              </div>
